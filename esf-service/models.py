...
class ESFModel(models.Model):
    ...
    document_uuid = fields.CharField(max_length=64, null=True, unique=True)
    ...
    currencyRate = fields.FloatField(null=True, description="Курс валюты к сому")
    totalCurrencyValue = fields.FloatField(null=True, description="Общая стоимость")
    totalCurrencyValueWithoutTaxes = fields.FloatField(null=True, description="Общая стоимость без налогов")
    ...
    catalogEntries = fields.JSONField(description="Товары")
    openingBalances = fields.JSONField(null=True, description="Сальдо на начало")
    assessedContributionsAmount = fields.FloatField(null=True, description="Начислено")
    paidAmount = fields.FloatField(null=True, description="Оплачено")
    penaltiesAmount = fields.FloatField(null=True, description="Штраф")
    finesAmount = fields.FloatField(null=True, description="Пеня")
    closingBalances = fields.FloatField(null=True, description="Сальдо на конец")
    amountToBePaid = fields.FloatField(null=True, description="К оплате")
